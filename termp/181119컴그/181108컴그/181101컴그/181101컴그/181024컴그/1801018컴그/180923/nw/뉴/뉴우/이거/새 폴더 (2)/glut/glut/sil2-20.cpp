...
void display(void)
{
	...
	board->DrawBoard(700, false, true);
...
void TimerFunc(int value)
{
	...
	else if (hexahedron->Position().x < -500)
	{
	...
	//hexahedron->SetPosition(hexahedron->Position().x + 5 * dir, hexahedron->Position().y, hexahedron->Position().z);

	//hexahedron2->Translate(5 * dir, 0, 0);
	//hexahedron3->Translate(5 * dir, 0, 0);
...
void Start()
{
	...
	control = hexahedron;
	control->SetPosition(0, -280, 100);
	hexahedron->rotationAccumulate = true;
	hexahedron2->SetPosition(0, -180, 100);
	hexahedron2->Scale(1, 3, 1);
	hexahedron2->rotationAccumulate = true;
	hexahedron3->SetPosition(0, -30, 100);
