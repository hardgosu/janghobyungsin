...
void Keyboard(unsigned char key, int x, int y)
{
	...
	if (key == 'w')
	{
		openCube->test[4] = true;
		openCube->myAnimatorParameter[2].animatorParameter.animationActivate = true;
	}
	if (key == 'W')
	{
		openCube->test[5] = true;
		openCube->myAnimatorParameter[2].animatorParameter.animationActivate = true;
	}
	...
	if (key == 's')
	{
		...
		openCube->test[0] = true;
		openCube->myAnimatorParameter[0].animatorParameter.animationActivate = true;

	}
	if (key == 'S')
	{

		openCube->test[3] = true;
		openCube->myAnimatorParameter[1].animatorParameter.animationActivate = true;
